<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pinggateway.aspx.cs" Inherits="WebApplication7.pinggateway" %>
    ...
    <div>
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style8" style="color: #FFFF00; font-size: medium; font-weight: bold">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Ping Gateway<table class="auto-style16">
                    <tr>
                        <td class="auto-style17">
                            <asp:Label ID="Label6" runat="server" Font-Bold="True" ForeColor="White" Text="Street"></asp:Label>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DropDownList2" runat="server" Height="18px" Width="128px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="auto-style17" style="color: #FFFFFF; font-weight: bold; font-size: medium">Gateway ID</td>
                        <td>
                    ...
                    <asp:Button ID="Button1" runat="server" BackColor="Yellow" style="margin-left: 105px" Text="Ping" Width="89px" />
                    <asp:Button ID="Button2" runat="server" BackColor="Yellow" style="margin-left: 43px" Text="Cancel" Width="96px" />
                </td>
            </tr>
            <tr>
