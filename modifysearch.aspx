<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="modifysearch.aspx.cs" Inherits="WebApplication7.modifysearch" %>
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style8">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<table class="auto-style16">
                    <tr>
                        <td class="auto-style19" style="color: #FFFFFF; font-weight: bold; font-size: medium">To</td>
                        <td class="auto-style20">
                            <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style19" style="color: #FFFFFF; font-weight: bold; font-size: medium">From</td>
                        <td class="auto-style20">
                            <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style19" style="color: #FFFFFF; font-weight: bold; font-size: medium">Street</td>
                        <td class="auto-style20">
                    ...
                    <tr>
                        <td class="auto-style18" style="color: #FFFFFF; font-size: medium; font-weight: bold">City</td>
                        <td class="auto-style17">
                    ...
                    <tr>
                        <td class="auto-style18" style="color: #FFFFFF; font-weight: bold; font-size: medium">State</td>
                        <td class="auto-style17">
                    ...
                    <asp:Button ID="Button1" runat="server" BackColor="Yellow" style="margin-left: 179px" Text="View" Width="132px" />
                </td>
            </tr>
            <tr>
