<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="survey.aspx.cs" Inherits="WebApplication7.survey" %>
                ...
                <td class="auto-style8">&nbsp;&nbsp; &nbsp;<table class="auto-style16">
                    <tr>
                        <td class="auto-style17">
                            <asp:Image ID="Image1" runat="server" Height="136px" ImageUrl="~/images.png" Width="125px" />
                            <asp:Image ID="Image3" runat="server" Height="138px" ImageUrl="~/t2_2434571b.jpg" style="margin-left: 5px" Width="321px" />
                        </td>
                    </tr>
                    <tr>
                        <td style="color: #FFFFFF; font-weight: bold; font-size: medium">A Traffic Survey is a Survey undertaken to determine the volume and/or nature of traffic utilizing a particular route a traffic survey can be manual or automatic The various types of Traffic Survey are: Volume Survey(Traffic Count), Speed Survey, Classification Counts, Gap Studies, Turning Movement, Multilane Classification, pedestrain Surveys,.</td>
                    </tr>
                    </table>
                </td>
            </tr>
