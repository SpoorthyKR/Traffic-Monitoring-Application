<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Result.aspx.cs" Inherits="WebApplication7.result" %>
    ...
    <div>
     <table class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style8" style="color: #FFFF00; font-weight: bold; font-size: medium">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;Results<table class="auto-style16">
                    <tr>
                        <td class="auto-style17" style="color: #FFFFFF; font-weight: bold; font-size: medium">*Required Type</td>
                        <td>
                    ...
                    <tr>
                        <td class="auto-style17" style="font-weight: bold; font-size: medium; color: #FFFFFF">From</td>
                        <td>
                            <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="auto-style17" style="color: #FFFFFF; font-weight: bold; font-size: medium">To</td>
                        <td>
                    ...
                    <asp:Button ID="Button1" runat="server" BackColor="Yellow" Height="26px" style="margin-left: 86px" Text="All Queries" Width="102px" />
                    <asp:Button ID="Button2" runat="server" BackColor="Yellow" Height="27px" style="margin-left: 50px; margin-top: 0px" Text="UnRead" Width="102px" />
                </td>
            </tr>
            <tr>
